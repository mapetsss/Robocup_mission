...
用法：
  python3 tools/capture_calibration_images.py --topic /camera/image_raw
...
def main():
    ...
    parser.add_argument("--topic", default="/camera/image_raw", help="输入图像话题")
    parser.add_argument(
        "--output-dir",
        default="/home/banana/detect_ws/calibration/images",
        help="图片保存目录",
    )
    ...
    try:
        while True:
            ...
            if frame is None:
                print("还没有收到图像，请确认 /camera/image_raw 正在发布。")
                continue
